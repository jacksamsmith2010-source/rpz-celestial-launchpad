...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "CELESTIAL" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@celestialvr" },
      { name: "twitter:title", content: "CELESTIAL — ORION DRIFT Esports" },
      { name: "twitter:description", content: "Official home of CELESTIAL, a competitive VR esports org competing in Orion Drift. We offer rosters, schedules, stats, and recruitment." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=DM+Sans:opsz,wght@9..40,400;9..40,500;9..40,700&family=Space+Grotesk:wght@300;400;500;600;700&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
